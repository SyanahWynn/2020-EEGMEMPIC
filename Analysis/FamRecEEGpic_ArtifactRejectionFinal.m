...
% adjust colourgroups
plotgroups = curexperiment.plotgroups;
% adjust channel count (because of removale of CMS & Status)
plotgroups = plotgroups(1:34);
