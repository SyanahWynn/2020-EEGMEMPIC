%% MAIN ANALYSES
% FamRecEEGpic made with fieldtrip-20160401
...
if any(strcmp(curexperiment.analyses,'plot'))
    %% PLOTS
    % run a script that plots the grand averages
    eval([curexperiment.name '_Plotting_GrandAverage'])
end
